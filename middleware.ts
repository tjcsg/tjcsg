...
export const config = {
  ...
  matcher: ['/((?!api|_next/static|_next/image|favicon.ico|android-chrome-96x96|apple-touch-icon|browserconfig.xml|favicon-16x16|favicon-32x32|mstile-150x150|safari-pinned-tab|robots|manifest).*)'],
};
